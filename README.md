...
# Feature Engineering: 
Adds new features, scales numerical features, and encodes categorical data.
...
# Explainability: 
Provides SHAP visualizations to interpret model predictions.

# Reproducibility: 
Includes random seed settings for consistent results.
...
git clone <https://github.com/SHAKSHIY/NEST>
cd NEST
...
|-- finalNEST.ipynb               # Main code for analysis with all the plots included in it. 
                                  # This file is #downloaded form google colab which is done 
                                  # by me.
